...
namespace Mustafa.Migrations
{
    ...
    [Migration("20210502212919_reverseentity")]
    partial class reverseentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mustafa.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mustafa.Domain.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mustafa.Domain.Entities.StockMoveType", b =>
                {
                    b.Property<bool>("Id")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("StockMoveType");
                });

            modelBuilder.Entity("Mustafa.Domain.Entities.Unitline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mustafa.Domain.Entities.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mustafa.Domain.Entities.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Mustafa.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Mustafa.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Mustafa.Domain.Entities.StockMove", b =>
                {
                    ...
                    b.HasOne("Mustafa.Domain.Entities.StockMoveType", "StockMoveType")
                        .WithMany("GetStockMove")
                        .HasForeignKey("StockMoveTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Mustafa.Domain.Entities.Product", b =>
                {
                    b.Navigation("GetStockMoves");
                });

            modelBuilder.Entity("Mustafa.Domain.Entities.StockMoveType", b =>
                {
                    b.Navigation("GetStockMove");
                });
