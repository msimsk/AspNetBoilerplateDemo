...
{
    public abstract class MustafaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MustafaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MustafaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MustafaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MustafaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MustafaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MustafaDbContext, Task<T>> func)
        {
            T result;
